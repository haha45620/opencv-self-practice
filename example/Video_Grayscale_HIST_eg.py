...
class AnimatedCameraHistogram:
    def __init__(self):
        ...
        self.fig, (self.ax_cam, self.ax_cam_gray,self.ax_hist) = plt.subplots(1, 3, figsize=(12, 5))
    ...
    def update_frame(self, frame_num):
        ...
        return [self.img_display, self.img_display_gray,self.hist_line, self.stats_text]
